(define (problem khunpan97-ac-gen)
    (:domain khunpan97-ac-gen)
    (:objects 
        h1 h2 h3 h4
        v1 v2 v3 v4 v5
    ...
    (:init 
        ...
        (at to1 h1 v4) (at tsq h2 v4) (at tsq h3 v4) (at to4 h4 v4)
        (at tv1 h1 v3) (at th1 h2 v3) (at th1 h3 v3) (at tv2 h4 v3)
        (at tv1 h1 v2) (at to2 h2 v2) (at to3 h3 v2) (at tv2 h4 v2)
        (at th2 h1 v1) (at th2 h2 v1) (at th3 h3 v1) (at th3 h4 v1)

        (= (total-cost) 0) (prev th1)
    )

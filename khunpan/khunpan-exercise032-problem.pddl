(define (problem khunpan-exercise032)
    (:domain khunpan-exercise032)
    (:objects 
        h1 h2 h3 h4
        v1 v2 v3 v4 v5
	)
    (:init 
        ...
        (at to3 h1 v4) (at tsq h2 v4) (at tsq h3 v4) (at to4 h4 v4)
        (empty h1 v3) (at th1 h2 v3) (at th1 h3 v3) (empty h4 v3)
        (at th2 h1 v2) (at th2 h2 v2) (at th3 h3 v2) (at th3 h4 v2)

(define (problem khunpan-exercise042)
    (:domain khunpan-exercise042)
    (:objects 
        h1 h2 h3 h4
        v1 v2 v3 v4 v5
	)
    (:init 
        ...
        (empty h1 v4) (at tsq h2 v4) (at tsq h3 v4) (empty h4 v4)
        (at tv1 h1 v3) (at tsq h2 v3) (at tsq h3 v3) (at tv2 h4 v3)
        (at tv1 h1 v2) (at th3 h2 v2) (at th3 h3 v2) (at tv2 h4 v2)

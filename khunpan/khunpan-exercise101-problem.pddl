(define (problem khunpan-exercise101)
    (:domain khunpan-exercise101)
    (:objects 
        h1 h2 h3 h4
        v1 v2 v3 v4 v5
	)
    (:init 
        ...
        (at to1 h1 v2) (at th2 h2 v2) (at th2 h3 v2) (at to2 h4 v2)
        (at to3 h1 v1) (at th3 h2 v1) (at th3 h3 v1) (at to4 h4 v1)

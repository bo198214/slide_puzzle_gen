(define (domain n8puzzle-ac-it-typing)
  ...
  (:constants tile1 - type1 tile2 - type1 tile3 - type1 tile4 - type1 tile5 - type1 tile6 - type1 tile7 - type1 tile8 - type1)
  ...
  (:action move-count1-prev_tile2-type1-s
   ...
   :precondition (and 
        ...
        (adjsn ?y0 ?y1)
        (empty ?x1 ?y0)
        (prev tile2) (not (prev ?t))
    )
   :effect (and 
        (not (at ?t ?x1 ?y1)) (empty ?x1 ?y1)
        (at ?t ?x1 ?y0) (not (empty ?x1 ?y0))
        (not (prev tile2)) (prev ?t) (increase (total-cost) 1)
    )
  )
  ...
  (:action move-count1-prev_tile3-type1-s
   ...
   :precondition (and 
        ...
        (adjsn ?y0 ?y1)
        (empty ?x1 ?y0)
        (prev tile3) (not (prev ?t))
    )
   :effect (and 
        (not (at ?t ?x1 ?y1)) (empty ?x1 ?y1)
        (at ?t ?x1 ?y0) (not (empty ?x1 ?y0))
        (not (prev tile3)) (prev ?t) (increase (total-cost) 1)
    )
  )
  ...
  (:action move-count1-prev_tile4-type1-s
   ...
   :precondition (and 
        ...
        (adjsn ?y0 ?y1)
        (empty ?x1 ?y0)
        (prev tile4) (not (prev ?t))
    )
   :effect (and 
        (not (at ?t ?x1 ?y1)) (empty ?x1 ?y1)
        (at ?t ?x1 ?y0) (not (empty ?x1 ?y0))
        (not (prev tile4)) (prev ?t) (increase (total-cost) 1)
    )
  )
  ...
  (:action move-count1-prev_tile5-type1-s
   ...
   :precondition (and 
        ...
        (adjsn ?y0 ?y1)
        (empty ?x1 ?y0)
        (prev tile5) (not (prev ?t))
    )
   :effect (and 
        (not (at ?t ?x1 ?y1)) (empty ?x1 ?y1)
        (at ?t ?x1 ?y0) (not (empty ?x1 ?y0))
        (not (prev tile5)) (prev ?t) (increase (total-cost) 1)
    )
  )
  ...
  (:action move-count1-prev_tile6-type1-s
   ...
   :precondition (and 
        ...
        (adjsn ?y0 ?y1)
        (empty ?x1 ?y0)
        (prev tile6) (not (prev ?t))
    )
   :effect (and 
        (not (at ?t ?x1 ?y1)) (empty ?x1 ?y1)
        (at ?t ?x1 ?y0) (not (empty ?x1 ?y0))
        (not (prev tile6)) (prev ?t) (increase (total-cost) 1)
    )
  )
  ...
  (:action move-count1-prev_tile7-type1-s
   ...
   :precondition (and 
        ...
        (adjsn ?y0 ?y1)
        (empty ?x1 ?y0)
        (prev tile7) (not (prev ?t))
    )
   :effect (and 
        (not (at ?t ?x1 ?y1)) (empty ?x1 ?y1)
        (at ?t ?x1 ?y0) (not (empty ?x1 ?y0))
        (not (prev tile7)) (prev ?t) (increase (total-cost) 1)
    )
  )
  ...
  (:action move-count1-prev_tile8-type1-s
   ...
   :precondition (and 
        ...
        (adjsn ?y0 ?y1)
        (empty ?x1 ?y0)
        (prev tile8) (not (prev ?t))
    )
   :effect (and 
        (not (at ?t ?x1 ?y1)) (empty ?x1 ?y1)
        (at ?t ?x1 ?y0) (not (empty ?x1 ?y0))
        (not (prev tile8)) (prev ?t) (increase (total-cost) 1)
    )
  )
